...
- Programmer Level จะเป็นการเขียนโปรแกรมด้วยโค้ด</br>`,
      params: {
        highlight: true,
      }
    },
...
we'll take a look later`,
    ...
    {//3
      target: "#inspire > div.application--wrap > nav > div > div:nth-child(2)",
      content: `This menu for change IDE's mode, let take a look inside`,
      params: {
        highlight: true,
      }
    },
    {//4
      target: "#inspire > div.v-dialog__content.v-dialog__content--active > div > div > div.v-card__text > div > div > div",
      content: `KBIDE have 2 modes</br>
- Kid Level : block programming</br>
- Programmer Level : text C/CPP programming</br>`,
      params: {
        highlight: true,
      }
    },
    {//5
      target: "#inspire > div.v-dialog__content.v-dialog__content--active > div > div > div.v-card__actions > button:nth-child(3)",
      content: `We'll change to Programmer mode, let see what gonna happen`,
      params: {
        highlight: true,
      }
    },
    ...
    {//12
      target: "#inspire > div.v-dialog__content.v-dialog__content--active > div > div > div.smooth-scrollbar > div.scroll-content > div",
      content: `We group examples together some example have block, code or event tutorial if you lucky</br></br> Remember : every window open by here will not backup the code and settings, please save manually before close`,
      params: {
        highlight: true,
      }
    },
