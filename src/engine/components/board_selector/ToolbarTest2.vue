<template>
    <div>
        <v-tooltip bottom>
            <v-btn color="primary darken-2" slot="activator" icon @click="musicDialog = true">
            ...
            <div slot="widget-content">
                <v-dialog v-model="musicDialog" max-width="785px">
                    <v-card>
                        ...
                        <v-card-actions>
                            <v-spacer></v-spacer>
                            <v-btn color="blue darken-1" flat @click="musicDialog = false">Cancel</v-btn>
                            <v-btn color="blue darken-1" flat @click="musicDialog = false">OK</v-btn>
                        </v-card-actions>
                    </v-card>
                </v-dialog>                
            </div>
