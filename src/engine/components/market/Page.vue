<template>
    <v-container grid-list-md text-xs-center>
        <v-layout row wrap style="margin-bottom: 100px">
            ...
            <!-- Electronics -->
            <category-electronic></category-electronic>

            <v-flex xs12 sm10>
                <v-layout row wrap>
                    <v-flex v-for="i in 6" :key="`3${i}`" xs12 sm3>
                        <v-card>
                            <v-img
...
<script>
  import CategoryComponent from "./components/electronic/Category";
  ...
  export default {
    ...
    components: {
      "category-electronic": CategoryComponent
    }
  };
</script>
